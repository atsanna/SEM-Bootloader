...
const unsigned char mDebugMain_TITLE[]	PROGMEM = 	"SEMBoot for Arduino Ethernet, Version 0.6";
		#else
const unsigned char mDebugMain_TITLE[]	PROGMEM = 	"SEMBoot for Arduino Uno, Version 0.6";
		#endif
	#elif defined(__AVR_ATmega2560__)
const unsigned char mDebugMain_TITLE[]	PROGMEM = 	"SEMBoot for Arduino Mega2560, Version 0.6";
	#elif defined(__AVR_ATmega1284P__)
const unsigned char mDebugMain_TITLE[]	PROGMEM = 	"SEMBoot for Arduino Mega1284P, Version 0.6";
	#else
const unsigned char mDebugMain_TITLE[]	PROGMEM = 	"Unknown MCU with ariadne, Version 0.6";
	#endif
